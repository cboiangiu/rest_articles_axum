...
@Composable
fun DetailScreen(objectId: String, navigateBack: () -> Unit) {
        ...
        Column(
            ...
            SelectionContainer {
                Column(Modifier.padding(12.dp)) {
                    ...
                    LabeledInfo(stringResource(R.string.label_date), obj.publishedDate.epochSeconds.toString())
                    LabeledInfo(stringResource(R.string.label_content), obj.content)
                }
            }
        }
    }
